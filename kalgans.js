...
🌷 KALAU MAU RENAME TARO CREDITS GUA : 𝐍𝐀𝐍𝐃𝐎✯𝐕𝐈𝐏 */
...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./basenando/lib/exif')
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./basenando/lib/myfunc')
//=================================================//
var low
try {
low = require('lowdb')
} catch (e) {
low = require('./basenando/lib/lowdb')}
//=================================================//
const { Low, JSONFile } = low
const mongoDB = require('./basenando/lib/mongoDB')
//=================================================//
...
new mongoDB(opts['db']) :
new JSONFile(`basenando/dbnye/database.json`)
)
...
browser: ['Saya Nandooo','Safari','1.0.0'],
auth: state})
//=================================================//
...
let buttons = [
{buttonId: `𝐍𝐀𝐍𝐃𝐎✯𝐕𝐈𝐏`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./basenando/lib/tes.xlsx'),
mimetype: feler,
...
let { writeExif } = require('./basenando/lib/exif')
...
ext: '.bin'}
filename = path.join(__filename, '../basenando/dbnye/' + new Date * 1 + '.' + type.ext)
